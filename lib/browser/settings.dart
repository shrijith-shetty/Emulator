      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            subtitle: Text(_getSearchEngineName(widget.settings.searchEngine)),
          ...
          ListTile(
            ...
            subtitle: Text("${widget.historyManager.history.length} items"),
          ...
          ListTile(
            ...
            subtitle: Text("${widget.bookmarkManager.bookmarks.length} items"),
