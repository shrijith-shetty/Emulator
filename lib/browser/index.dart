...
class HomePageState extends State<HomePage>
{
    ...
    {
        super.initState();
        tabManager = TabManager(homepage: browserSettings.homepage);
        ...
        // Listen to settings changes for dark mode
        browserSettings.addListener(_onSettingsChanged);
    }
    ...
    void dispose() 
    {
        browserSettings.removeListener(_onSettingsChanged);
        searchFocus.dispose();
